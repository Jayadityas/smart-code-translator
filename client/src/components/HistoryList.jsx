...
/*Each history item shows the operation type, languages, date, and a delete button. 
e.stopPropagation() on the delete button prevents the click from also triggering onView */
