...
function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
        //If isSignUp is true, it calls register function otherwise it calls emailLogin function 
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    try {
        //If google login succeeds, our backend returns a JWT token and the user's profile. 
